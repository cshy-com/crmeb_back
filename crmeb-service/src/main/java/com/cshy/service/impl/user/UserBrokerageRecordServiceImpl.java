...
import com.cshy.common.model.response.SpreadCommissionDetailResponse;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.cshy.common.utils.ArrayUtil;
...
import com.cshy.common.model.request.RetailShopStairUserRequest;
import com.cshy.common.model.entity.user.User;
import com.cshy.common.model.entity.user.UserBrokerageRecord;
import com.cshy.service.dao.user.UserBrokerageRecordDao;
...
public class UserBrokerageRecordServiceImpl extends ServiceImpl<UserBrokerageRecordDao, UserBrokerageRecord> implements UserBrokerageRecordService {
    ...
    public Map<String, Integer> getSpreadCountByUidAndMonth(Integer uid, List<String> monthList) {
        ...
        list.forEach(record -> {
            map.put(DateUtil.dateToStr(record.getUpdateTime(), DateConstants.DATE_FORMAT_MONTH), record.getUid());
        });
        return map;
    }
