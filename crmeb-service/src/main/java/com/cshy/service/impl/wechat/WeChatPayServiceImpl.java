...
import com.cshy.common.model.vo.order.CreateOrderH5SceneInfoDetailVo;
import com.cshy.common.model.vo.order.CreateOrderH5SceneInfoVo;
...
public class WeChatPayServiceImpl implements WeChatPayService {
    ...
    public Boolean queryPayResult(String orderNo) {
        ...
        if ("order".equals(pre)) {// 支付订单
            ...
            // 查询订单信息
            MyRecord record = wechatCommonService.payOrderQuery(payVo);
