...
import com.cshy.service.dao.store.StoreCouponUserDao;
    ...
    */
    ...
    public CommonPage<StoreCouponUserResponse> getMyCouponList(String type, PageParamRequest pageParamRequest) {
        ...
        for (StoreCouponUser storeCouponUser :couponUserList) {
            ...
            // 更改使用时间格式，去掉时分秒
            storeCouponUserResponse.setUseStartTimeStr(DateUtil.dateToStr(storeCouponUserResponse.getStartTime(), DateConstants.DATE_FORMAT_DATE));
            storeCouponUserResponse.setUseEndTimeStr(DateUtil.dateToStr(storeCouponUserResponse.getEndTime(), DateConstants.DATE_FORMAT_DATE));
