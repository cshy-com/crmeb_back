...
import com.cshy.service.dao.store.StoreBargainUserDao;
    ...
    */
    ...
    public PageInfo<StoreBargainUserResponse> getList(StoreBargainUserSearchRequest request, PageParamRequest pageParamRequest) {
        ...
        List<StoreBargainUserResponse> list = bargainUserList.stream().map(bargainUser -> {
            ...
            bargainUserResponse.setAddTime(DateUtil.timestamp2DateStr(bargainUser.getAddTime(), DateConstants.DATE_FORMAT));
            ...
            bargainUserResponse.setDataTime(DateUtil.timestamp2DateStr(storeBargain.getStopTime(), DateConstants.DATE_FORMAT));
